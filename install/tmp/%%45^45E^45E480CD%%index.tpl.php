<?php /* Smarty version 2.6.26, created on 2014-06-21 18:32:03
	...
	<form method="post" action="">
		<table>
			<tr>
				...
				<td><input class="input" type="text" name="url" placeholder="Adres URL" value="<?php echo $this->_tpl_vars['url']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Serwer bazy danych:</td>
				<td><input class="input" type="text" name="serwer" placeholder="Serwer mysql" value="<?php echo $this->_tpl_vars['serwer']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Port serwera bazy danych:</td>
				<td><input class="input" type="text" name="port" placeholder="Port serwera" value="<?php echo $this->_tpl_vars['port']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Nazwa użytkownika bazy danych:</td>
				<td><input class="input" type="text" name="uzytkownik" placeholder="Użytkownik" value="<?php echo $this->_tpl_vars['uzytkownik']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Nazwa bazy danych:</td>
				<td><input class="input" type="text" name="nazwa" placeholder="Nazwa bazy" value="<?php echo $this->_tpl_vars['nazwa']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Hasło do bazy danych:</td>
				<td><input class="input" type="password" name="haslo" placeholder="Hasło do bazy" value="<?php echo $this->_tpl_vars['haslo']; ?>
"/></td>
			</tr>
			<tr>
				<td>Login do systemu CMS:</td>
				<td><input class="input" type="text" name="logincms" placeholder="Login do CMS" value="<?php echo $this->_tpl_vars['logincms']; ?>
" required/></td>
			</tr>
			<tr>
				<td>Hasło do systemu CMS:</td>
				<td><span class="red">Podane hasła są różne</span><input class="input" type="password" name="haslocms" placeholder="Hasło do CMS" value="<?php echo $this->_tpl_vars['haslocms']; ?>
" required/></td>
			</tr>
			<tr>
